...
class MADDPG:
    ...
    def learn(self, memory):
        ...
        for agent_idx, agent in enumerate(self.agents):
            ...
            actor_loss = actor_loss.detach().requires_grad_(True)  # actor_loss = actor_loss.detach().requires_grad_(True)
            actor_loss.backward(retain_graph=True)   # actor_loss.backward(retain_graph=True)
            actor_loss.backward()
